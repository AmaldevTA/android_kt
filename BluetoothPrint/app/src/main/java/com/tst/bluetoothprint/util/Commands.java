package com.tst.bluetoothprint.util;
...
public class Commands {
    ...
    // Alignment
    public static final byte[] LINE_LEFT       = {0x1b,'a',0x00}; // Set the line left aligned
    public static final byte[] LINE_CENTER     = {0x1b,'a',0x01}; // Set the line center aligned
    public static final byte[] LINE_RIGHT      = {0x1b,'a',0x02}; // Set the line right aligned
